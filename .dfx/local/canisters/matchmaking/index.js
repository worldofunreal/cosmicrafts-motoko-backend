...
export const canisterId = process.env.CANISTER_ID_MATCHMAKING;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./matchmaking.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the matchmaking canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./matchmaking.did.js")._SERVICE>}
 */
export const matchmaking = createActor(canisterId);
