...
import { idlFactory } from './cosmicrafts.did.js';
export { idlFactory } from './cosmicrafts.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.COSMICRAFTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cosmicrafts.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cosmicrafts canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cosmicrafts.did.js")._SERVICE>}
 */
export const cosmicrafts = createActor(canisterId);
