...
export const canisterId = process.env.CANISTER_ID_STATISTICS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./statistics.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the statistics canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./statistics.did.js")._SERVICE>}
 */
export const statistics = createActor(canisterId);
