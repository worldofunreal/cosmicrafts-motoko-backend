...
export const canisterId = process.env.CANISTER_ID_VALIDATOR;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./validator.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the validator canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./validator.did.js")._SERVICE>}
 */
export const validator = createActor(canisterId);
