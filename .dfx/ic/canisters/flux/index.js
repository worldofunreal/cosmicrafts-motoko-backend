...
import { idlFactory } from './flux.did.js';
export { idlFactory } from './flux.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.FLUX_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./flux.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the flux canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./flux.did.js")._SERVICE>}
 */
export const flux = createActor(canisterId);
