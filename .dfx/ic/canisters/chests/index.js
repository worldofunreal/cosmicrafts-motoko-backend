...
import { idlFactory } from './chests.did.js';
export { idlFactory } from './chests.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CHESTS_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./chests.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the chests canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./chests.did.js")._SERVICE>}
 */
export const chests = createActor(canisterId);
