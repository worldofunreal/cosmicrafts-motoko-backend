...
import { idlFactory } from './rewards.did.js';
export { idlFactory } from './rewards.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_REWARDS;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./rewards.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the rewards canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./rewards.did.js")._SERVICE>}
 */
export const rewards = createActor(canisterId);
