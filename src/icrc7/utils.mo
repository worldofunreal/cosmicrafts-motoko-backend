...
module {
	...
	return [
		...
		("Predator", 20, 140, 2, "A versatile fighter capable of taking down both air and ground targets.", "url_to_predator_image"),
		...
		("Pulverizer", 10, 180, 3, "A heavily armored fighter designed to take and deal massive damage.", "url_to_pulverizer_image"),
