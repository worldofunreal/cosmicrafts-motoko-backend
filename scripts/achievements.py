...
def create_category(name, achievements, required_progress, rewards):
    ...
    command = f"dfx canister call cosmicrafts createCategory '{input_data}'"
...
def create_achievement(name, individual_achievements, required_progress, category_id, rewards):
    ...
    command = f"dfx canister call cosmicrafts createAchievement '{input_data}'"
    out, err = run_dfx_command(command, input_data)
    return out, err
...
def create_individual_achievement(name, achievement_type, required_progress, rewards, achievement_id):
    ...
    command = f"dfx canister call cosmicrafts createIndividualAchievement '{input_data}'"
    out, err = run_dfx_command(command, input_data)
    return out, err

def get_achievements():
    command = "dfx canister call cosmicrafts getAchievements"
